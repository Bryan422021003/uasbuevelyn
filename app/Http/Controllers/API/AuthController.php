...
class AuthController extends Controller
{
     ...
     *             example={"name": "Bryan Charity", "email": "bryanch30@gmail.com", "password": "Bryan3010$", "password_confirmation": "Bryan3010"}
     *         ),
     *     )
     * )
     */
    public function register(Request $request){
        try {
            ...
            $token      = $user->createToken('UAS Bu Evelyn Password Grant Client')->accessToken; // string inside createToken is the token name
     ...
     *         @OA\JsonContent(
     *             ref="#/components/schemas/User",
     *             example={"email": "bryanch30@gmail.com", "password": "Bryan3010"}
     *         ),
     *     )
     * )
     */
